...
let yummy = foods.slice(1, 3); // Create a new array with elements from index 1 to 2 (end index is non-inclusive)
...
for (const num of nums) {
  // Check if the current number is odd by using the modulo operator (%)(remainder must be 0)
  if (num % 2 !== 0) {
...
for (const subArray of numArrays) {
  // Iterate through each number within the nested array
